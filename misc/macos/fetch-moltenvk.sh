...
#
# Why install_name @rpath/libvulkan.1.dylib: the trinity binary carries
# LC_RPATH=@executable_path (set by the darwin Makefile block), so any
# @rpath-named dylib next to it in Trinity.app/Contents/MacOS/ resolves
